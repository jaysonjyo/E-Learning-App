      ...
      body: SafeArea(
        child: Center(
          child: Padding(
            ...
            child: Column(
              children: [
                SizedBox(width: 220.w,height: 150.h,
                ...
                Container(
                  ...
                  decoration: ShapeDecoration(
                      ...
                      shape: RoundedRectangleBorder(
                          ...
                          side: BorderSide(width: 0.10.w, color: Colors.black12))),
                  child: Padding(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text("Email",style:GoogleFonts.mulish(
                            textStyle:  TextStyle(color: Colors.black,fontSize:18.sp,fontWeight: FontWeight.w500),),
                        ),)
                      ],
                    ),
                  ),
                    ...
                    children: [
                      ...
                      Padding(
                       ...
                       child: IconButton(
                            ...
                            icon:value==true?
                            FaIcon(FontAwesomeIcons.eyeSlash):Icon(Icons.remove_red_eye_outlined),
                    ...
                    children: [
                      Padding(
                        ...
                        child: CircleAvatar(backgroundColor: Colors.green,radius: 15,
                          child: Checkbox(
                            value: ischecked,activeColor:Colors.white,
                            shape: CircleBorder(),checkColor: Colors.green,
                            onChanged: ( value) {
                              setState(() {
                               ischecked =! ischecked;
                              },);
                      ...
                      Text("Agree to Terms & Con",style:GoogleFonts.mulish(
                    ...
                    child: Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: CircleAvatar(backgroundColor: Colors.white,radius: 20.r,
                      ...
                      TextButton(onPressed: (){
                        ...
                        child: Text('SIGN IN',
                          style: TextStyle(
                            ...
                            fontSize: 16.sp,
                            fontWeight: FontWeight.w700,
                            height: 0.h,decoration: TextDecoration.underline,
                          ),
                        ),
                      ),
                    ],
